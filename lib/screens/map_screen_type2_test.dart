...
class MapScreenType2Test extends StatefulWidget {
  ...
  @override
  State<MapScreenType2Test> createState() => _MapScreenType2TestState();
}

class _MapScreenType2TestState extends State<MapScreenType2Test> {
  List<Field> fields = [];
  ...
  void _goToAddScreen2() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => AddScreenType2Test(
          polygons: _polygons,
          polygonArea: _polygonArea,
          lengths: widget.lengths,
          polygonAreaMeters: polygonAreaMeters,
